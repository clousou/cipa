...
<div class="box-body">
  <div class="row">
	<div class="col-md-12">
	  <form id="frm" method="post" class="form-horizontal" action="<?php echo site_url('artikel/save'); ?>" enctype="multipart/form-data">
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="form-control" id="detail" name="detail" rows="5"  placeholder="Detail" required></textarea>
				</div>
			</div>
			<div class="form-group"> 
